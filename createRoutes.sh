...
curl -i -X POST --url http://localhost:8001/services/ --data 'name=create' --data 'url=http://kafkaproducer:3004'
...
curl -i -X POST --url http://localhost:8001/services/ --data 'name=update' --data 'url=http://kafkaproducer:3004'
...
curl -i -X POST --url http://localhost:8001/services/ --data 'name=delete' --data 'url=http://kafkaproducer:3004'
