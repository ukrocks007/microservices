...
curl -i -X POST --url http://localhost:8001/services/ --data 'name=update' --data 'url=http://update:3002/update'
...
curl -i -X POST --url http://localhost:8001/services/ --data 'name=delete' --data 'url=http://delete:3003/delete'
